...
tomo$domain$long_west 			 <- -20
tomo$domain$long_east 			 <- 65
...
tomo$domain$limit_long_east 	 <- tomo$domain$long_east - 1
tomo$domain$limit_long_west 	 <- tomo$domain$long_west + 1
